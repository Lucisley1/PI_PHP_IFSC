...
<div> 
    ...
    <div class="box">
        <!-- <form action="saveEditProduto.php" method="POST"> -->
            <fieldset>
                <legend><b>Prazo de Garantia</b></legend>
                <br>
                ...
                <div class="inputBox">
                    ...
                    <br>
                    <input type="text" name="marca" id="marca" class="inputUser" value="<?php echo $marca ?>" disabled>
                </div>
                <br>
                <div class="inputBox">
                    <label for="modelo" class="labelInput">Modelo</label>
                    <br>
                    <input type="text" name="modelo" id="modelo" class="inputUser" value="<?php echo $modelo ?>" disabled>
                </div>
                <br>
                <div class="inputBox">
                    <label for="defeito" class="labelInput">Defeito</label>
                    <br>
                    <input type="text" name="defeito" id="defeito" class="inputUser" value="<?php echo $defeito ?>" disabled>
                </div>
                <br>
                <div class="inputBox">
                    <label for="peca_defeito" class="labelInput">Peça com defeito</label>
                    <br>
                    <input type="text" name="peca_defeito" id="peca_defeito" class="inputUser" value="<?php echo $peca_defeito ?>" disabled>
                </div>
                <br>
                <div class="inputBox">
                    <label for="valor_peca" class="labelInput">Valor da peça</label>
                    <br>
                    <input type="text" name="valor_peca" id="valor_peca" class="inputUser" value="<?php echo $valor_peca ?>" disabled>
                </div>
                <br>
                <div class="inputBox">
                    <label for="statuss" class="labelInput">Status</label>
                    <br>
                    <input type="text" name="statuss" id="statuss" class="inputUser" value="<?php echo $statuss ?>" disabled>
                </div>
                <br>
                <div class="inputBox">
                    <label for="statuss" class="labelInput">Data da Retirada</label>
                    <br>
                    <input type="text" name="data" id="data" class="inputUser" value="<?php echo $data ?>" disabled>
                </div>
                <br>
                <div class="inputBox">
                    <label for="garantia" class="labelInput">Prazo da Garantia</label>
                    <br>
